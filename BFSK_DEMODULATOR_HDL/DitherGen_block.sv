// -------------------------------------------------------------
// 
// File Name: C:\Users\pc\Documents\MATLAB\MY_FSK\HDL_DEMODULATOR\hdlsrc\FSK_DEMODULATOR_HARDWARE_MODEL\HARDWARE_FRIENDLY_FSK\DitherGen_block.sv
...
// Source Path: HARDWARE_FRIENDLY_FSK/FSK_DEMODULATOR_HARDWARE_MODEL/NCO1/DitherGen
// Hierarchy Level: 2
// Model version: 1.17
// 
...
module DitherGen_block
          (  input logic clk,
             ...
             input logic enb,
             input logic validIn,
             output logic [14:0] dither  /* ufix15 */);


  logic [18:0] pn_newvalue14;  /* ufix19 */
  logic [17:0] pn_newvaluesf14;  /* ufix18 */
  logic bit0_14;  /* ufix1 */
  logic bit14_14;  /* ufix1 */
  logic bit17_14;  /* ufix1 */
  logic [18:0] pn_newvalue13;  /* ufix19 */
  logic [17:0] pn_newvaluesf13;  /* ufix18 */
  logic bit0_13;  /* ufix1 */
  logic bit14_13;  /* ufix1 */
  logic bit17_13;  /* ufix1 */
  logic [18:0] pn_newvalue12;  /* ufix19 */
  logic [17:0] pn_newvaluesf12;  /* ufix18 */
  logic bit0_12;  /* ufix1 */
  logic bit14_12;  /* ufix1 */
  logic bit17_12;  /* ufix1 */
  logic [18:0] pn_newvalue11;  /* ufix19 */
  logic [17:0] pn_newvaluesf11;  /* ufix18 */
  logic bit0_11;  /* ufix1 */
  logic bit14_11;  /* ufix1 */
  logic bit17_11;  /* ufix1 */
  logic [18:0] pn_newvalue10;  /* ufix19 */
  logic [17:0] pn_newvaluesf10;  /* ufix18 */
  logic bit0_10;  /* ufix1 */
  logic bit14_10;  /* ufix1 */
  logic bit17_10;  /* ufix1 */
  logic [18:0] pn_newvalue9;  /* ufix19 */
  logic [17:0] pn_newvaluesf9;  /* ufix18 */
  logic bit0_9;  /* ufix1 */
  logic bit14_9;  /* ufix1 */
  logic bit17_9;  /* ufix1 */
  logic [18:0] pn_newvalue8;  /* ufix19 */
  logic [17:0] pn_newvaluesf8;  /* ufix18 */
  logic bit0_8;  /* ufix1 */
  logic bit14_8;  /* ufix1 */
  logic bit17_8;  /* ufix1 */
  logic [18:0] pn_newvalue7;  /* ufix19 */
  logic [17:0] pn_newvaluesf7;  /* ufix18 */
  logic bit0_7;  /* ufix1 */
  logic bit14_7;  /* ufix1 */
  logic bit17_7;  /* ufix1 */
  logic [18:0] pn_newvalue6;  /* ufix19 */
  logic [17:0] pn_newvaluesf6;  /* ufix18 */
  logic bit0_6;  /* ufix1 */
  logic bit14_6;  /* ufix1 */
  logic bit17_6;  /* ufix1 */
  logic [18:0] pn_newvalue5;  /* ufix19 */
  logic [17:0] pn_newvaluesf5;  /* ufix18 */
  logic bit0_5;  /* ufix1 */
  logic bit14_5;  /* ufix1 */
  logic bit17_5;  /* ufix1 */
  logic [18:0] pn_newvalue4;  /* ufix19 */
  logic [17:0] pn_newvaluesf4;  /* ufix18 */
  logic bit0_4;  /* ufix1 */
  logic bit14_4;  /* ufix1 */
  logic bit17_4;  /* ufix1 */
  logic [18:0] pn_newvalue3;  /* ufix19 */
  logic [17:0] pn_newvaluesf3;  /* ufix18 */
  logic bit0_3;  /* ufix1 */
  logic bit14_3;  /* ufix1 */
  logic bit17_3;  /* ufix1 */
  logic [18:0] pn_newvalue2;  /* ufix19 */
  logic [17:0] pn_newvaluesf2;  /* ufix18 */
  logic bit0_2;  /* ufix1 */
  logic bit14_2;  /* ufix1 */
  logic bit17_2;  /* ufix1 */
  logic [18:0] pn_newvalue1;  /* ufix19 */
  logic [17:0] pn_newvaluesf1;  /* ufix18 */
  logic bit0_1;  /* ufix1 */
  logic bit14_1;  /* ufix1 */
  logic bit17_1;  /* ufix1 */
  logic [18:0] pn_reg;  /* ufix19 */
  logic [17:0] pn_newvaluesf0;  /* ufix18 */
  logic bit14_0;  /* ufix1 */
  logic bit17_0;  /* ufix1 */
  logic bit18_0;  /* ufix1 */
  logic bit0_0;  /* ufix1 */
  ...
  logic bit18_9;  /* ufix1 */
  logic xorout9;  /* ufix1 */
  logic bit18_10;  /* ufix1 */
  logic xorout10;  /* ufix1 */
  logic bit18_11;  /* ufix1 */
  logic xorout11;  /* ufix1 */
  logic bit18_12;  /* ufix1 */
  logic xorout12;  /* ufix1 */
  logic bit18_13;  /* ufix1 */
  logic xorout13;  /* ufix1 */
  logic bit18_14;  /* ufix1 */
  logic xorout14;  /* ufix1 */
  logic [18:0] pn_newvalue15;  /* ufix19 */
